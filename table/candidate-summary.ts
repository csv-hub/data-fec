...
import { candidateSummaryTransport, candidateSummaryCSV } from './transport'
...
@table('candidate_summary', {
    ...
    transport: YEARS_FROM_1980.map(candidateSummaryTransport),
    csv: YEARS_FROM_1980.map(candidateSummaryCSV)
})
